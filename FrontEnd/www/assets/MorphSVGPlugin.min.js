...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = t || self).window = t.window || {}) }(this, function(t) {
    ...
    var b = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        ...
        Q = Math.abs,
        J = Math.sqrt,
        h = function _isNumber(t) { return "number" == typeof t },
        s = function _round(t) { return Math.round(1e5 * t) / 1e5 || 0 };
    ...
    function stringToRawPath(t) {
        function yc(t, e, n, r) { g = (n - t) / 3, c = (r - e) / 3, h.push(t + g, e + c, n - g, r - c, n, r) }
        var e, n, r, o, i, a, h, s, l, g, c, f, p, u, d, P = (t + "").replace(A, function(t) { var e = +t; return e < 1e-4 && -1e-4 < e ? 0 : e }).match(b) || [],
            _ = [],
            w = 0,
            m = 0,
            v = P.length,
    ...
    function y() { return n || "undefined" != typeof window && (n = window.gsap) && n.registerPlugin && n }

    function z(t) { return "function" == typeof t }

    function M(t) { return console && console.warn(t) }

    function P() { return String.fromCharCode.apply(null, arguments) }
    ...
    function V(t, e) { return e.length - t.length }
    ...
    function ja(t) { var e = t.trim().split(" "); return { x: (~t.indexOf("left") ? 0 : ~t.indexOf("right") ? 100 : isNaN(parseFloat(e[0])) ? 50 : parseFloat(e[0])) / 100, y: (~t.indexOf("top") ? 0 : ~t.indexOf("bottom") ? 100 : isNaN(parseFloat(e[1])) ? 50 : parseFloat(e[1])) / 100 } }
    ...
    function ma(t, e, n, r) {
        var o, i, a = this._origin,
            ...
            g = w(s * s + l * l),
            c = v(l, s);
        return s = e[n] - h.x, l = e[n + 1] - h.y, i = function _shortAngle(t) { return t !== t % f ? t + (t < 0 ? p : -p) : t }(o = v(l, s) - c), !r && F && Math.abs(i + F.ca) < u && (r = F), this._anchorPT = F = { _next: this._anchorPT, t: t, sa: c, ca: r && i * r.ca < 0 && Math.abs(i) > d ? o : i, sl: g, cl: w(s * s + l * l) - g, i: n }
    }

    function na(t) { n = y(), o = o || n && n.plugins.morphSVG, n && o ? (j = n.utils.toArray, o.prototype._tweenRotation = ma, I = 1) : t && M("Please gsap.registerPlugin(MorphSVGPlugin)") }
    var n, j, F, I, o, v = Math.atan2,
        ...
        K = {
            ...
            name: "morphSVG",
            rawVars: 1,
            register: function register(t, e) { n = t, o = e, na() },
            init: function init(t, e, n, r, o) {
                ...
                if (s = function _parseShape(t, e, n) { var r, o; return (!("string" == typeof t) || G.test(t) || (t.match(L) || []).length < 3) && ((r = j(t)[0]) ? (o = (r.nodeName + "").toUpperCase(), e && "PATH" !== o && (r = convertToPath(r, !1), o = "PATH"), t = r.getAttribute("PATH" === o ? "d" : "points") || "", r === n && (t = r.getAttributeNS(null, "data-original") || t)) : (M("WARNING: invalid morph to: " + t), t = !1)), t }(e.shape || e.d || e.points || "", "d" === a, t), l && q.test(s)) return M("A <" + i + "> cannot accept path data. " + B), !1;
                if (g = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", c = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, s) {
                    if (this._target = t, y = "object" == typeof e.precompile, u = this._prop ? t[this._prop] : t.getAttribute(a), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" === a || this._prop) {
                        ...
                        for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (u = ia(u, e.smoothTolerance), d = ia(d, e.smoothTolerance), u.size || U(u), d.size || U(d), b = ja(C[0]), this._origin = u.origin = { x: u.left + b.x * u.width, y: u.top + b.y * u.height }, C[1] && (b = ja(C[1])), this._eOrigin = { x: d.left + b.x * d.width, y: d.top + b.y * d.height }), this._rawPath = t._gsRawPath = u, _ = u.length; - 1 < --_;)
                            for (m = u[_], v = d[_], f = m.isSmooth || [], p = v.isSmooth || [], w = m.length, P = F = 0; P < w; P += 2) v[P] === m[P] && v[P + 1] === m[P + 1] || (S ? f[P] && p[P] ? (x = m.smoothData, T = v.smoothData, N = P + (P === w - 4 ? 7 - w : 5), this._controlPT = { _next: this._controlPT, i: P, j: _, l1s: x[P + 1], l1c: T[P + 1] - x[P + 1], l2s: x[N], l2c: T[N] - x[N] }, h = this._tweenRotation(m, v, P + 2), this._tweenRotation(m, v, P, h), this._tweenRotation(m, v, N - 1, h), P += 4) : this._tweenRotation(m, v, P) : (h = this.add(m, P, m[P], v[P]), h = this.add(m, P + 1, m[P + 1], v[P + 1]) || h))
            ...
            convertToPath: function convertToPath$1(t, e) { return j(t).map(function(t) { return convertToPath(t, !1 !== e) }) },
            defaultType: "linear",
